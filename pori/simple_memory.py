"""
Simple per-session memory system for Pori agents.

This replaces the complex multi-layered memory with a clean, easy-to-understand
session-based memory that handles all the core functionality.
"""
...
class SimpleMemory:
    """
    Simple per-session memory for agents.
    
    This provides all the essential memory functionality without the complexity
    of vector stores, persistent storage, or multiple memory layers.
    """
