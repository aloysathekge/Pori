...
def _builder_task(
    ...
    return (
        ...
        "supplied by the host. Work through the bounded Surface workspace: inspect "
        "the current project, make exact edits, run the trusted checks, and finish "
        "the checked candidate; do not describe or claim a publication. Aloy's "
        "host persists, validates, builds, previews, and publishes it. Never "
        "convert schedule rows, display sections, "
        "or navigation "
