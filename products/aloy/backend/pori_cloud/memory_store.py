...
database that pori_cloud already uses. Each user gets persistent memory
...
class PostgresMemoryStore:
    ...
    the async operations. However, for the pori_cloud use case we
    ...
    # --- Async API (used by pori_cloud directly) ---
